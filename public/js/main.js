...
//initialization of socketID connection
const socket = io("/");
...
personalCodeChatButton.addEventListener('click', () =>{
	...
	console.log('Personal Code Chat Button');
...
personalCodeVideoButton.addEventListener('click', () =>{
	...
	console.log('Personal Code Video Button');
	const calleePersonalCode = document.getElementById('personal_code_input').value;
...
//register event for allow connections from Strangers Checkbox
...
//*************Fim do codigo Mostrar Tela do PC***************************/
...
// changer class local_video
const localVideo = document.getElementById('local_video');
localVideo.addEventListener("click", () => {  
  ui.changerVideoLocal();
});

// changer class remote_video
